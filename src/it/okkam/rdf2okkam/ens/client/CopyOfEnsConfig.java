...
public class CopyOfEnsConfig {
	...
	public CopyOfEnsConfig(String path) throws IOException {
		//Properties prop = new Properties();
		...
		prop.load(new FileInputStream("extensions/ENSUploader/config/rdf2okkam.properties"));
		
		
		this.username = prop.getProperty("username");
		System.out.println(this.username);
		this.password =prop.getProperty("password");
		this.pointer = prop.getProperty("pointer");
		
		

	}
	
	public CopyOfEnsConfig(String path, String file_name) throws IOException {
		Properties prop = new Properties();
